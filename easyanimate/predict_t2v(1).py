...
# 添加在最上方或导入模块后
parser = argparse.ArgumentParser(description="Run EasyAnimate with dynamic prompt input")
parser.add_argument('--prompt', type=str, required=True, help='Prompt to describe the scene')
parser.add_argument('--negative_prompt', type=str, default="扭曲的身体，肢体残缺，文本字幕，漫画，静止，丑陋，错误，乱码。", help='Negative prompt to avoid undesirable results')
...
#negative_prompt     = "扭曲的身体，肢体残缺，文本字幕，漫画，静止，丑陋，错误，乱码, 安静，固定。"
# 
